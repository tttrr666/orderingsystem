                                                                    ...
                                                                    <table>
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="2" style="height: 40px;"><a
                                                                                    href="${pageContext.request.contextPath}/orders/order_addshoppingcar?menuId=<%=menus.getId()%>"><img
                                    ...
                                    <div id='pdv_' class='pdv_class'
                                        ...
                                        <div id='spdv_3603' class='pdv_content'
                                            ...
                                            <div class="pdv_border"
                                                ...
                                                <div
                                                        style="height: 100%; background: url(${pageContext.request.contextPath}/public/qiantai/images/right.jpg) right repeat-y">
                                                    <div
                                                        ...
                                                        <div id="dingcanche2">
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="center"><a
                                                                            href="${pageContext.request.contextPath}/orders/order_shoppingcardel?del=<%=i%>">取消</a>
                                                                    </td>
                                                                </tr>
                                                                <%
                                                                        }
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0">
                                                                    <tr>
                                                                        ...
                                                                        <td align="center" width="40%"><a
                                                                                ...
                                                                                border="0"/></a></td>
                                                                        <td align="center" width="40%"><a
                                                                                href="${pageContext.request.contextPath}/orders/order_addshoppingcartoOrder?remove=1"><img
