				...
				<tr>
					<td align="left" valign="top">
						...
						<div align="center" width="120">
							<form action="${pageContext.request.contextPath}/orders/order_qiantai" name="form1" method="post">
								<table id="table1"   class="line_table" style="width: 500px;  margin: 0; padding: 0" cellSpacing="0" cellPadding="0">
									...
									<tr >
										<td class="line_table" align="center" colspan="3" >
											<a href="${pageContext.request.contextPath}/orders/ordergetall" >我的所有订单</a>&nbsp;&nbsp;&nbsp;&nbsp;
											<a href="${pageContext.request.contextPath}/orders/ordergetallbydelivery?delivery=0" >未已派送订单</a>&nbsp;&nbsp;&nbsp;&nbsp;
											<a href="${pageContext.request.contextPath}/orders/ordergetallbydelivery?delivery=1" >已派送订单</a>&nbsp;&nbsp;&nbsp;&nbsp;
										</td>
									</tr>
								</table>
							</form>
