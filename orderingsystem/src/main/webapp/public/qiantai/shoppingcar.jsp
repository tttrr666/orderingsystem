				...
				<tr>
				  ...
				  %>
								<tr>
									...
									<td class="line_table" align="center" width="20%"><a href="${pageContext.request.contextPath}/orders/order_shoppingcardel?del=<%=i%>">取消</a></td>
								</tr>
									<%
						}
		              }
					 ...
					 %>
								...
								<tr   >
									<td class="line_table" align="center"  colspan="4" valign="center">
										...
										<a href="${pageContext.request.contextPath}/orders/order_addshoppingcartoOrder"><img src="${pageContext.request.contextPath}/public/qiantai/images/canche_submit.gif" border="0" /></a>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

										<a href="${pageContext.request.contextPath}/orders/order_addshoppingcartoOrder?remove=1"><img src="${pageContext.request.contextPath}/public/qiantai/images/quxiao2.gif" border="0" /></a>
