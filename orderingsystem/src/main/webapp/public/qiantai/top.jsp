...
<%@page import="com.example.meal_ordering_system.controller.UsersController" %>
<html>
<head>
                ...
                <div class="pdv_border" style="margin:0;padding:0;height:100%;border:0px  solid;background:;">
                    ...
                    <div style="padding:0px">
                        ...
                        <div id="topmenu">
                            ...
                            <a href="${pageContext.request.contextPath}/public/qiantai/login.jsp"
                               target="_self">会员登录</a>|
                            ...
                            <a href="${pageContext.request.contextPath}/public/qiantai/carry.jsp"
                               target="_self">猜你喜欢</a>|
                        ...
                        <div id="menu">
                            ...
                            <div id="mainmenu">
                                <ul>
                                    ...
                                    <li><a href="${pageContext.request.contextPath}/public/qiantai/order.jsp"
                                           target="_self">我的订单</a></li>
                                    <li><a href="${pageContext.request.contextPath}/public/qiantai/center.jsp"
                                           target="_self" onclick="checkSession()">用户中心</a></li>

                                    <li><a href="${pageContext.request.contextPath}/public/qiantai/carry.jsp"
                                           target="_self">猜你喜欢</a></li>

                                    <li><a href="${pageContext.request.contextPath}/public/qiantai/our.jsp"
        ...
        <div id='pdv_3608' class='pdv_class' title='' style='width:208px; height:100px; top:-22px; left:0px; z-index:9'>
            <div id='spdv_3608' class='pdv_top' style='overflow:hidden;width:100%;height:100%'>
                <div class="pdv_border" style="margin:0;padding:0;height:100%;border:0px  solid;background:;">
                    ...
                    <div style="padding:0px">
                        <img src="${pageContext.request.contextPath}/public/qiantai/images/1.png" alt=""
                             width="40%" border="0"/>
                    </div>
