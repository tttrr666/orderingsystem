		...
		<tr>
			...
			<td valign="top" bgcolor="#F7F8F9">
				...
				<div align="center">
					...
					<form name="form1" action="${pageContext.request.contextPath}/admin/update"
						...
						<table id="table3" class="line_table"
							...
							<tbody style="margin: 0; padding: 0">
								...
								<tr>
									...
									<td class="line_table" align="left" width="55%">
										<input type="text" name="name" size="20" value="<%=admin.getName()%>"></td>
								</tr>
								<tr>
									<td class="line_table" align="right" width="45%"><span
